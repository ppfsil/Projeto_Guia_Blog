...
public class Postagem {
	...
	@Size(min = 5, max = 100, message = "O atributo título deve conter no mínimo 05 e no máximo 100 caracteres") // aqui
																													// determinamos
																													// o
																													// tamanho
																													// da
	...
	@UpdateTimestamp // anotação + configuração da variavel = será preenchida automático com o fuso
						// horário do sistema (data e hora)
